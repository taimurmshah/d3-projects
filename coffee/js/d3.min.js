...
(function(t, n) {
  ...
  function h(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= ns ? 10 : o >= es ? 5 : o >= rs ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= ns ? 10 : o >= es ? 5 : o >= rs ? 2 : 1);
  }
  function d(t, n, e) {
      ...
      (m = m.merge(
        ...
        (S = S.merge(
          T.append("text")
            .attr("fill", "#000")
            .attr(s, c * p)
            .attr("dy", t === os ? "0em" : t === us ? "0.71em" : "0.32em")
        )),
        e !== b &&
          ((m = m.transition(e)),
          (w = w.transition(e)),
    ...
    return (
      ...
      (e.tickArguments = function(t) {
        return arguments.length
          ? ((r = null == t ? [] : is.call(t)), e)
          : r.slice();
      }),
      (e.tickValues = function(t) {
        return arguments.length
          ? ((i = null == t ? null : is.call(t)), e)
          : i && i.slice();
      }),
      ...
      : function(t) {
          return function() {
            var n = this.ownerDocument,
              e = this.namespaceURI;
            return e === ls && n.documentElement.namespaceURI === ls
              ? n.createElement(t)
  ...
  function O(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < l; ++u)
      (f = n[u]) &&
        ((d[u] = c = ys + a.call(f, f.__data__, u, n)),
        c in s ? (i[u] = f) : (s[c] = f));
    for (u = 0; u < h; ++u)
      (f = s[(c = ys + a.call(t, o[u], u, o))])
  ...
  function kt(t) {
    ...
    return (
      ...
      (n = As.exec(t))
        ...
        : (n = Cs.exec(t))
        ? Dt(n[1], n[2] / 100, n[3] / 100, 1)
        : (n = Ps.exec(t))
        ? Dt(n[1], n[2] / 100, n[3] / 100, n[4])
        : zs.hasOwnProperty(t)
        ? Ct(zs[t])
        : "transparent" === t
  ...
  function Yt(t) {
    ...
    var e = Xt(t.r),
      r = Xt(t.g),
      i = Xt(t.b),
      o = It((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / Ds),
      a = It((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Us);
    return new Ft(
      116 * a - 16,
      500 * (o - a),
      200 * (a - It((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / qs)),
      t.opacity
    );
  }
  function Bt(t, n, e, r) {
  ...
  function nn(t, n) {
    var e = n - t;
    return e
      ? tn(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
      : Kt(isNaN(t) ? n : t);
  }
  function en(t) {
    return 1 == (t = +t)
  ...
  function Sn(t) {
    if (!bl) {
      ...
      t - Al > 24
        ? (t < 1 / 0 && (ml = setTimeout(Tn, t - Nl.now() - Tl)),
          xl && (xl = clearInterval(xl)))
        : (xl || ((Ml = Nl.now()), (xl = setInterval(Nn, wl))),
          (bl = 1),
          Sl(Tn));
    }
  }
  ...
  function kn(t, n, e, r, i, o) {
    ...
    (function(t, n, e) {
      function r(f) {
        var c, s, l, h;
        if (e.state !== Pl) return o();
        for (c in u)
          if ((h = u[c]).name === e.name) {
            if (h.state === Rl) return En(r);
            h.state === Ll
              ? ((h.state = Ul),
                h.timer.stop(),
                h.on.call("interrupt", t, t.__data__, h.index, h.group),
                delete u[c])
              : +c < n && ((h.state = Ul), h.timer.stop(), delete u[c]);
          }
        if (
          (En(function() {
            e.state === Rl &&
              ((e.state = Ll), e.timer.restart(i, e.delay, e.time), i(f));
          }),
          (e.state = zl),
          ...
          for (
            e.state = Rl, a = new Array((l = e.tween.length)), c = 0, s = -1;
            c < l;
            ++c
          )
        ...
        for (
          var r =
              n < e.duration
                ...
                : (e.timer.restart(o), (e.state = Dl), 1),
            i = -1,
            u = a.length;
          ++i < u;
      ...
      function o() {
        (e.state = Ul), e.timer.stop(), delete u[n];
  ...
  function Cn(t, n) {
    var e = zn(t, n);
    if (e.state > Cl) throw new Error("too late; already scheduled");
    return e;
  }
  function Pn(t, n) {
    var e = zn(t, n);
    if (e.state > zl) throw new Error("too late; already started");
    return e;
  }
  function zn(t, n) {
    ...
    function a() {
      ...
      function o() {
        ...
        p < c &&
          ...
          (c = p),
          (p = t),
          M in _h && Y.attr("cursor", yh[(M = _h[M])])),
          g < h &&
            ((N *= -1),
            (t = l),
            (l = v),
            ...
            (h = g),
            (g = t),
            M in bh && Y.attr("cursor", yh[(M = bh[M])])),
          S.selection && (k = S.selection),
          m && ((c = k[0][0]), (p = k[1][0])),
          x && ((h = k[0][1]), (g = k[1][1])),
          (k[0][0] === c && k[0][1] === h && k[1][0] === p && k[1][1] === g) ||
            ((S.selection = [[c, h], [p, g]]), r.call(w), q.brush());
      }
      function a() {
      ...
      if (s.apply(this, arguments)) {
        ...
        "overlay" === M
          ? (S.selection = k = [
              [(u = n === vh ? C : D[0]), (l = n === ph ? P : D[1])],
              [(d = n === vh ? z : u), (v = n === ph ? R : l)]
            ])
      ...
      (e.extent = function(t) {
        return arguments.length
          ? ((c =
              "function" == typeof t
                ? t
                : Gn([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])),
            e)
          : c;
      }),
      (e.filter = function(t) {
        return arguments.length
          ? ((s = "function" == typeof t ? t : Gn(!!t)), e)
          : s;
      }),
      ...
      return (
        (function(t, n, r) {
          ...
          var u,
            ...
            d = new Array(),
            p = new Array();
          (u = f = -1), (s = t[0] >= n), Lh[s << 1].forEach(a);
          for (; ++u < i - 1; )
          ...
          for (; ++f < o - 1; ) {
            for (
              ...
              (c = s),
                ...
                (h = l),
                (l = t[f * i + u + 1] >= n),
                Lh[c | (s << 1) | (l << 2) | (h << 3)].forEach(a);
            Lh[s | (l << 3)].forEach(a);
          }
          (u = -1), (l = t[f * i] >= n), Lh[l << 2].forEach(a);
          for (; ++u < i - 1; )
            (h = l),
              (l = t[f * i + u + 1] >= n),
              Lh[(l << 2) | (h << 3)].forEach(a);
          Lh[l << 3].forEach(a);
        })(t, n, function(e) {
          f(e, t, n),
            (function(t) {
    ...
    function n(t, n) {
      function e() {
        ...
        if (t.charCodeAt(r) === qh) {
          for (
            ;
            (u++ < a && t.charCodeAt(u) !== qh) || t.charCodeAt(++u) === qh;
          ...
          return (
            (n = u) >= a
              ...
              : (e = t.charCodeAt(u++)) === Oh
              ? (s = !0)
              : e === Yh && ((s = !0), t.charCodeAt(u) === Oh && ++u),
            t.slice(r + 1, n - 1).replace(/""/g, '"')
          );
        }
        for (; u < a; ) {
          if ((e = t.charCodeAt((n = u++))) === Oh) s = !0;
          else if (e === Yh) (s = !0), t.charCodeAt(u) === Oh && ++u;
      ...
      var r,
        ...
        s = !1;
      for (
        t.charCodeAt(a - 1) === Oh && --a, t.charCodeAt(a - 1) === Yh && --a;
        (r = e()) !== Uh;

      ) {
        for (var l = []; r !== Dh && r !== Uh; ) l.push(r), (r = e());
    ...
    function n(t) {
      function n(t) {
        ...
        switch (
          (d &&
            l &&
            ((t = e(M + t, M.length ? h - m.length : 1 / 0)), (M = "")),
          f)
        ) {
          case "<":
            t = s + t + m + M;
  ...
  function or(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Qe(n) / 3))) - Qe(Math.abs(t))
    );
  }
  function ar(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Qe(n) - Qe(t)) + 1
    );
  }
  function ur() {
    return new fr();
  ...
  function Cr(t, n) {
    ...
    if (xd) {
      ...
      c ^ (u * _d < f && f < u * t)
        ...
        c
          ? t < _d
            ? Ur(pd, t) > Ur(pd, gd) && (gd = t)
            : Ur(t, gd) > Ur(pd, gd) && (pd = t)
          : gd >= pd
          ? (t < pd && (pd = t), t > gd && (gd = t))
          : t > _d
          ? Ur(pd, t) > Ur(pd, gd) && (gd = t)
          : Ur(t, gd) > Ur(pd, gd) && (pd = t);
    } else wd.push((Md = [(pd = t), (gd = t)]));
    n < vd && (vd = n), n > yd && (yd = n), (xd = e), (_d = t);
  }
  function Pr() {
    dp.point = Cr;
  }
  ...
  function Vr(t, n) {
    (Dd = t), (Ud = n), (t *= $d), (n *= $d), (pp.point = $r);
    var e = Jd(n);
    (qd = e * Jd(t)), (Od = e * rp(t)), (Yd = rp(n)), Br(qd, Od, Yd);
  }
  function $r(t, n) {
    t *= $d;
    var e = Jd((n *= $d)),
  ...
  function ei(t) {
    ...
    return (
      (t = Jr(t[0] * $d, t[1] * $d, t.length > 2 ? t[2] * $d : 0)),
      (n.invert = function(n) {
        return (
          (n = t.invert(n[0] * $d, n[1] * $d)), (n[0] *= Vd), (n[1] *= Vd), n
        );
      }),
      n
    );
        ...
        if (!((n = t.length - 1) <= 0)) {
          ...
          if (ai(r, a)) {
            ...
            u.push((e = new ui(r, t, null, !0))),
              f.push((e.o = new ui(r, null, e, !1))),
              u.push((e = new ui(a, t, null, !1))),
              f.push((e.o = new ui(a, null, e, !0)));
        }
      }),
      u.length)
    ) {
  ...
  function si(t, n) {
    var e = n[0],
      ...
      a = 0,
      u = 0;
    Np.reset(), 1 === i ? (r = Hd + Fd) : -1 === i && (r = -Hd - Fd);
      ...
      var h,
        ...
        m = {
          ...
          polygonEnd: function() {
            ...
            var t = si(h, r);
            d.length
              ? (b || (i.polygonStart(), (b = !0)), fi(d, di, t, e, i))
              : t &&
  ...
  function di(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Hd - Fd : Hd - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Hd - Fd : Hd - n[1])
    );
  }
  function pi(t) {
    function n(t, n) {
        ...
        return {
          ...
          point: function(l, h) {
            ...
            if (
              (!i && (c = f = v) && t.lineStart(),
              v !== f &&
                (!(d = e(i, p)) || ai(i, d) || ai(p, d)) &&
                ((p[0] += Fd), (p[1] += Fd), (v = n(p[0], p[1]))),
              v !== f)
            )
              (s = 0),
                v
    ...
    return function(a) {
      ...
      function c(o, a) {
        ...
        if ((l && h.push([o, a]), m))
          ...
          var f = [
              (g = Math.max(kp, Math.min(Ep, g))),
              (_ = Math.max(kp, Math.min(Ep, _)))
            ],
            c = [
              (o = Math.max(kp, Math.min(Ep, o))),
              (a = Math.max(kp, Math.min(Ep, a)))
            ];
  ...
  function _i(t, n) {
    ...
    var e = rp((n *= $d)),
      ...
      u = yp * e - gp * r * o,
      f = gp * e + yp * r * o;
    Cp.add(Qd(op(a * a + u * u), f)), (vp = t), (gp = e), (yp = r);
  }
  function bi(t) {
  ...
  function ki() {
    ...
    function n() {
      return s(Kd(o / y) * y, i, y)
        .map(d)
        .concat(s(Kd(c / _) * _, f, _).map(p))
        .concat(
          s(Kd(r / v) * v, e, v)
            .filter(function(t) {
              return Wd(t % y) > Fd;
    ...
    return (
      ...
      t
        .extentMajor([[-180, -90 + Fd], [180, 90 - Fd]])
        .extentMinor([[-180, -80 - Fd], [180, 80 + Fd]])
    );
  }
  function Ci(t) {
    return t;
          ...
          function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
            ...
            if (b > 4 * n && v--) {
              var m = a + h,
                ...
                A = lr((w /= M)),
                T =
                  Wd(Wd(w) - 1) < Fd || Wd(o - l) < Fd ? (o + l) / 2 : Qd(x, m),
                N = t(T, A),
                S = N[0],
                E = N[1],
                k = S - r,
  ...
  function oo(t) {
    ...
    function e() {
      ...
      return (
        (o = Jr(b, m, x)), (s = Zr(i, n)), (l = Zr(o, s)), (c = eo(s, S)), r()
      );
    }
    function r() {
      return (h = d = null), n;
    ...
    function n() {
      ...
      return c(
        null == s
          ...
          : t === ho
          ? [[Math.max(a[0] - n, s), e], [Math.min(a[0] + n, r), i]]
          : [[s, Math.max(a[1] - n, e)], [r, Math.min(a[1] + n, i)]]
      );
    }
    var e,
      r,
    ...
    for (null == n && (n = Co); (e = c.pop()); )
      if ((f && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length)))
        for (e.children = new Array(a), o = a - 1; o >= 0; --o)
          c.push((r = e.children[o] = new Ro(i[o]))),
            (r.parent = e),
            (r.depth = e.depth + 1);
  ...
  function qo(t, n) {
    for (var e = 0; e < n.length; ++e) if (!Uo(t, n[e])) return !1;
    return !0;
  }
  function Oo(t, n) {
    var e = t.x,
  ...
  function Bo(t, n, e) {
    var r = t.x,
      ...
      c = u * u + f * f;
    if (c) {
      var s = 0.5 + ((a *= a) - (o *= o)) / (2 * c),
        l =
          Math.sqrt(Math.max(0, 2 * o * (a + c) - (a -= c) * a - o * o)) /
          (2 * c);
  ...
  function Ho(t) {
    ...
    t: for (u = 3; u < i; ++u) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = Io(n);
        (r = r.next) !== e;
    ...
    for (r = Lo(n), u = 0; u < i; ++u) (n = t[u]), (n.x -= r.x), (n.y -= r.y);
    return r.r;
  }
  function Xo(t) {
  ...
  function Zo(t, n) {
    return function(e) {
      if ((r = e.children)) {
        ...
        if (((o = Ho(r)), u)) for (i = 0; i < a; ++i) r[i].r -= u;
        e.r = o + u;
      }
    };
  }
  ...
  function ca(t, n, e, r, i, o) {
    for (
      ...
      y.push((a = { value: s, dice: f < c, children: _.slice(b, m) })),
        a.dice
          ? Ko(a, e, r, i, w ? (r += (c * s) / w) : o)
          : fa(a, e, r, w ? (e += (f * s) / w) : i, o),
        (w -= s),
        (b = m);
    }
    return y;
  ...
  function ha(t) {
    for (var n = t.length, e = [0, 1], r = 2, i = 2; i < n; ++i) {
      for (; r > 1 && sa(t[e[r - 2]], t[e[r - 1]], t[i]) <= 0; ) --r;
      e[r++] = i;
    }
    return e.slice(0, r);
  }
  ...
  function Ma(t, n) {
    function e() {
      return (
        (i = Math.min(u.length, f.length) > 2 ? xa : ma), (o = a = null), r
      );
    }
    function r(n) {
      return (o ||
      ...
      (n.tickFormat = function(n, r) {
        return (function(n, e, r) {
          ...
          switch ((r = Ke(null == r ? ",f" : r)).type) {
            ...
            case "r":
              null != r.precision ||
                isNaN((i = ar(u, Math.max(Math.abs(o), Math.abs(a))))) ||
  ...
  function La() {
    function n() {
      return (
        (o = za(i)), (a = Pa(i)), r()[0] < 0 && ((o = Ra(o)), (a = Ra(a))), e
      );
    }
  ...
  function Ya() {
    ...
    return (
      (t.domain = function(i) {
        return arguments.length
          ? ((n = Sv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : n.slice();
      }),
      (t.range = function(i) {
        return arguments.length
          ? ((e = Sv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : e.slice();
      }),
      (t.invertExtent = function(t) {
        var r = e.indexOf(t);
    ...
    return (
      ...
      e &&
        ((i.count = function(n, r) {
          return (
            Cv.setTime(+n), Pv.setTime(+r), t(Cv), t(Pv), Math.floor(e(Cv, Pv))
          );
        }),
        (i.every = function(t) {
          return (
  ...
  function Fa(t) {
    return Ba(
      ...
      function(t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Lv) / Dv
        );
      }
    );
  }
      ...
      return function(e) {
        ...
        if (("p" in a && (a.H = (a.H % 12) + 12 * a.p), "V" in a)) {
          ...
          "w" in a || (a.w = 1),
            "Z" in a
              ? ((i =
                  (o = (i = Ha(Xa(a.y))).getUTCDay()) > 4 || 0 === o
                    ? vg.ceil(i)
                    : vg(i)),
                (i = hg.offset(i, 7 * (a.V - 1))),
                (a.y = i.getUTCFullYear()),
                (a.m = i.getUTCMonth()),
                (a.d = i.getUTCDate() + ((a.w + 6) % 7)))
              : ((i =
                  (o = (i = n(Xa(a.y))).getDay()) > 4 || 0 === o
                    ? Xv.ceil(i)
                    : Xv(i)),
                (i = Iv.offset(i, 7 * (a.V - 1))),
                (a.y = i.getFullYear()),
                (a.m = i.getMonth()),
        ...
        return "Z" in a
          ? ((a.H += (a.Z / 100) | 0), (a.M += a.Z % 100), Ha(a))
          : n(a);
      };
    }
    function r(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, f = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = A[i in Rg ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function mf() {
    ...
    return (
      (t.x = function(e) {
        return arguments.length
          ? ((n = "function" == typeof e ? e : ff(+e)), t)
          : n;
      }),
      (t.y = function(n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : ff(+n)), t)
          : e;
      }),
      (t.defined = function(n) {
        return arguments.length
          ? ((r = "function" == typeof n ? n : ff(!!n)), t)
          : r;
      }),
      (t.curve = function(n) {
  ...
  function xf() {
    ...
    return (
      (t.x = function(n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : ff(+n)), (r = null), t)
          : e;
      }),
      (t.x0 = function(n) {
        return arguments.length
      ...
      (t.x1 = function(n) {
        return arguments.length
          ? ((r = null == n ? null : "function" == typeof n ? n : ff(+n)), t)
          : r;
      }),
      (t.y = function(n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : ff(+n)), (o = null), t)
          : i;
      }),
      (t.y0 = function(n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : ff(+n)), t)
          : i;
      }),
      (t.y1 = function(n) {
        return arguments.length
          ? ((o = null == n ? null : "function" == typeof n ? n : ff(+n)), t)
          : o;
      }),
  ...
  function zf(t) {
    ...
    return (
      ...
      (n.x = function(t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : ff(+t)), n)
          : i;
      }),
      (n.y = function(t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : ff(+t)), n)
          : o;
      }),
  ...
  function Jf(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (Qf(o) + Qf(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function Kf(t, n) {
  ...
  function kc(t) {
    var n = t.circle;
    n &&
      (n.P || (V_ = n.N), Z_.remove(n), J_.push(n), gc(n), (t.circle = null));
  }
  function Cc(t) {
    var n =
      K_.pop() ||
  ...
  function zc(t) {
    ...
    for (
      var f = o;
      f.circle &&
      Math.abs(e - f.circle.x) < tb &&
      Math.abs(r - f.circle.cy) < tb;
    ...
    for (
      var c = a;
      c.circle &&
      Math.abs(e - c.circle.x) < tb &&
      Math.abs(r - c.circle.cy) < tb;
    ...
    if (
      ((function() {
        for (var t, n, e, r, i = 0, o = W_.length; i < o; ++i)
          if ((t = W_[i]) && (r = (n = t.halfedges).length)) {
            var a = new Array(r),
              u = new Array(r);
            for (e = 0; e < r; ++e) (a[e] = e), (u[e] = Tc(t, Q_[n[e]]));
            for (
              a.sort(function(t, n) {
                return u[n] - u[t];
              }),
      ...
      (function(t, n, e, r) {
        for (var i, o = Q_.length; o--; )
          (Ac((i = Q_[o]), t, n, e, r) &&
            Mc(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > tb ||
              Math.abs(i[0][1] - i[1][1]) > tb)) ||
            delete Q_[o];
      })(a, u, f, c),
        (function(t, n, e, r) {
          var i,
            ...
            if ((o = W_[i])) {
              ...
              for (u = 0, c = f.length; u < c; )
                (p = (d = Sc(o, Q_[f[u]]))[0]),
                  ...
                  (l = (s = Nc(o, Q_[f[++u % c]]))[0]),
                  (h = s[1]),
                  (Math.abs(p - l) > tb || Math.abs(v - h) > tb) &&
                    (f.splice(
                      u,
                      0,
                      Q_.push(
                        xc(
                          a,
                          d,
                          Math.abs(p - t) < tb && r - v > tb
                            ? [t, Math.abs(l - t) < tb ? h : r]
                            : Math.abs(v - r) < tb && e - p > tb
                            ? [Math.abs(h - r) < tb ? l : e, r]
                            : Math.abs(p - e) < tb && v - n > tb
                            ? [e, Math.abs(l - e) < tb ? h : n]
                            : Math.abs(v - n) < tb && p - t > tb
                            ? [Math.abs(h - n) < tb ? l : t, n]
                            : null
                        )
                      ) - 1
                    ),
  ...
  if ("undefined" != typeof document) {
    ...
    if (!ps.matches) {
      var vs =
        ps.webkitMatchesSelector ||
        ps.msMatchesSelector ||
        ps.mozMatchesSelector ||
        ps.oMatchesSelector;
      ds = function(t) {
        return function() {
  ...
  if (((t.event = null), "undefined" != typeof document)) {
    "onmouseenter" in document.documentElement ||
      (_s = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }
  var bs = [null];
      ...
      function(t) {
        return "none" === t
          ...
          : ($s ||
              ...
              (Ws = document.documentElement),
              (Zs = document.defaultView)),
            ($s.style.transform = t),
            (t = Zs.getComputedStyle(Ws.appendChild($s), null).getPropertyValue(
              "transform"
            )),
            Ws.removeChild($s),
            (t = t.slice(7, -1).split(",")),
            dn(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
      },
      "px, ",
      "px)",
      "deg)"
    ...
    fl = pn(
      function(t) {
        return null == t
          ? al
          : (Qs ||
              (Qs = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "g"
              )),
            Qs.setAttribute("transform", t),
            (t = Qs.transform.baseVal.consolidate())
  ...
  wn.prototype = Mn.prototype = {
    ...
    restart: function(t, n, e) {
      ...
      (e = (null == e ? mn() : +e) + (null == n ? 0 : +n)),
        this._next ||
          Ks === this ||
          (Ks ? (Ks._next = this) : (Js = this), (Ks = this)),
        (this._call = t),
        (this._time = e),
        Sn();
    },
  ...
  Un.prototype = qn.prototype = {
    ...
    tween: function(t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = zn(this.node(), e).tween, o = 0, a = i.length;
          o < a;
          ++o
        )
  ...
  var Bl = (function t(n) {
    ...
    fh = { time: null, delay: 0, duration: 250, ease: Bn };
  (ft.prototype.interrupt = function(t) {
    ...
    (ft.prototype.transition = function(t) {
      ...
      t instanceof Un
        ? ((n = t._id), (t = t._name))
        : ((n = On()), ((e = fh).time = mn()), (t = null == t ? null : t + ""));
  ...
  (nd.copy = function() {
    ...
    (nd.visit = function(t) {
      var n,
        ...
        f = this._root;
      for (
        f && u.push(new Oe(f, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());
    ...
    (nd.visitAfter = function(t) {
      ...
      for (
        this._root &&
        e.push(new Oe(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
  ...
  rr({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }),
    (fr.prototype = {
      constructor: fr,
      reset: function() {
        this.s = this.t = 0;
    ...
    Kp = {
      ...
      result: function() {
        var t = Jp
          ...
          ? [Hp / Gp, Xp / Gp]
          : [NaN, NaN];
        return (Hp = Xp = Gp = Vp = $p = Wp = Zp = Qp = Jp = 0), t;
      }
    };
  Hi.prototype = {
    _radius: 4.5,
        ...
        if ((a = t._squarify) && a.ratio === n)
          for (
            ...
            for (
              ...
              u.value += f[c].value;
            u.dice
              ? Ko(u, e, r, i, (r += ((o - r) * u.value) / d))
              : fa(u, e, r, (e += ((i - e) * u.value) / d), o),
              (d -= u.value);
          }
  ...
  var Rv = zv.range,
    ...
    Iv = Ba(
      ...
      function(t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Lv) / 864e5
        );
      },
      function(t) {
        return t.getDate() - 1;
  ...
  var qg = "%Y-%m-%dT%H:%M:%S.%LZ",
    Og = Date.prototype.toISOString
      ? function(t) {
          return t.toISOString();
        }
      : t.utcFormat(qg),
    Yg = +new Date("2000-01-01T00:00:00.000Z")
      ? function(t) {
          var n = new Date(t);
    ...
    t_ = new Array(3)
      ...
      .map(of),
    n_ = af(t_),
    e_ = _l($t(300, 0.5, 0), $t(-240, 0.5, 1)),
    r_ = _l($t(-100, 0.75, 0.35), $t(80, 1.5, 0.8)),
    i_ = _l($t(260, 0.75, 0.35), $t(80, 1.5, 0.8)),
    o_ = $t(),
    a_ = uf(
      of(
    ...
    O_ = {
      draw: function(t, n) {
        ...
        t.moveTo(r, i),
          ...
          t.lineTo(-0.5 * u - D_ * f, D_ * u + -0.5 * f),
          t.lineTo(-0.5 * r + D_ * i, -0.5 * i - D_ * r),
          t.lineTo(-0.5 * o + D_ * a, -0.5 * a - D_ * o),
          t.lineTo(-0.5 * u + D_ * f, -0.5 * f - D_ * u),
          t.closePath();
      }
    },
        ...
        if (((t = +t), (n = +n), t !== this._x1 || n !== this._y1)) {
          switch (this._point) {
            ...
            case 1:
              ...
              break;
            case 2:
              (this._point = 3), tc(this, Kf(this, (e = Jf(this, t, n))), e);
              break;
            default:
      ...
      insert: function(t, n) {
        ...
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (yc(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                _c(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (_c(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              yc(this, r)),
            (e = t.U);
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C &&
                    ((n.C = !1), (i.C = !0), yc(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) ||
                    ((n.L.C = !1), (n.C = !0), _c(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    yc(this, i),
                    (t = this._);
                ...
                ((n = i.L).C &&
                  ((n.C = !1), (i.C = !0), _c(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) ||
                  ((n.R.C = !1), (n.C = !0), yc(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  _c(this, i),
                  (t = this._);
  ...
  (qc.prototype = {
    ...
    (Yc.prototype = {
      ...
      translate: function(t, n) {
        return (0 === t) & (0 === n)
          ? this
          : new Yc(this.k, this.x + this.k * t, this.y + this.k * n);
      },
      apply: function(t) {
  ...
  (Bc.prototype = Yc.prototype),
    ...
    (t.ribbon = function() {
      function t() {
        ...
        if (
          ...
          a.arc(0, 0, s, l, h),
          (l === g && h === y) ||
            (a.quadraticCurveTo(0, 0, v * wh(g), v * Mh(g)),
            a.arc(0, 0, v, g, y)),
      ...
      return (
        (t.radius = function(n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : ne(+n)), t)
            : r;
        }),
        (t.startAngle = function(n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : ne(+n)), t)
            : i;
        }),
        (t.endAngle = function(n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : ne(+n)), t)
            : o;
        }),
        (t.source = function(e) {
    ...
    (t.nest = function() {
      function t(n, i, a, u) {
        ...
        for (
          var f, c, s, l = -1, h = n.length, d = o[i++], p = se(), v = a();
          ++l < h;
    ...
    (t.contourDensity = function() {
      ...
      return (
        (t.x = function(n) {
          return arguments.length
            ? ((a = "function" == typeof n ? n : _e(+n)), t)
            : a;
        }),
        (t.y = function(n) {
          return arguments.length
            ? ((u = "function" == typeof n ? n : _e(+n)), t)
            : u;
        }),
        (t.size = function(t) {
    ...
    (t.forceCollide = function(t) {
      ...
      var i,
        ...
        u = 1;
      return (
        "function" != typeof t && (t = De(null == t ? 1 : +t)),
        ...
        (n.radius = function(e) {
          return arguments.length
            ? ((t = "function" == typeof e ? e : De(+e)), r(), n)
            : t;
        }),
        n
      );
    ...
    (t.forceLink = function(t) {
      function n(n) {
        for (var e = 0, r = t.length; e < d; ++e)
          for (var i, u, f, s, l, h, p, v = 0; v < r; ++v)
            (u = (i = t[v]).source),
              (s = (f = i.target).x + f.vx - u.x - u.vx || Ue()),
              (l = f.y + f.vy - u.y - u.vy || Ue()),
              (s *= h =
      ...
      function e() {
        if (u) {
          ...
          for (n = 0, f = new Array(l); n < h; ++n)
            ((e = t[n]).index = n),
              "object" != typeof e.source && (e.source = Ve(d, e.source)),
              "object" != typeof e.target && (e.target = Ve(d, e.target)),
      ...
      return (
        ...
        (n.strength = function(t) {
          return arguments.length
            ? ((l = "function" == typeof t ? t : De(+t)), r(), n)
            : l;
        }),
        (n.distance = function(t) {
          return arguments.length
            ? ((h = "function" == typeof t ? t : De(+t)), i(), n)
            : h;
        }),
        n
      );
    ...
    (t.forceManyBody = function() {
      ...
      return (
        ...
        (t.strength = function(e) {
          return arguments.length
            ? ((f = "function" == typeof e ? e : De(+e)), n(), t)
            : f;
        }),
    ...
    (t.forceRadial = function(t, n, e) {
      ...
      return (
        ...
        (r.strength = function(t) {
          return arguments.length
            ? ((f = "function" == typeof t ? t : De(+t)), i(), r)
            : f;
        }),
        (r.radius = function(n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : De(+n)), i(), r)
            : t;
        }),
        (r.x = function(t) {
    ...
    (t.forceX = function(t) {
      ...
      var r,
        ...
        a = De(0.1);
      return (
        "function" != typeof t && (t = De(null == t ? 0 : +t)),
        (n.initialize = function(t) {
          (r = t), e();
        }),
        (n.strength = function(t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : De(+t)), e(), n)
            : a;
        }),
        (n.x = function(r) {
          return arguments.length
            ? ((t = "function" == typeof r ? r : De(+r)), e(), n)
            : t;
        }),
        n
      );
    ...
    (t.geoBounds = function(t) {
      var n, e, r, i, o, a, u;
      if (
        ((yd = gd = -(pd = vd = 1 / 0)), (wd = []), yr(t, dp), (e = wd.length))
      ) {
        for (wd.sort(qr), n = 1, o = [(r = wd[0])]; n < e; ++n)
          Or(r, (i = wd[n])[0]) || Or(r, i[1])
            ? (Ur(r[0], i[1]) > Ur(r[0], r[1]) && (r[1] = i[1]),
              Ur(i[0], r[1]) > Ur(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (u = Ur(r[1], i[0])) > a && ((a = u), (pd = i[0]), (gd = r[1]));
      }
      return (
        (wd = Md = null),
        pd === 1 / 0 || vd === 1 / 0
    ...
    (t.geoCentroid = function(t) {
      (Ad = Td = Nd = Sd = Ed = kd = Cd = Pd = zd = Rd = Ld = 0), yr(t, pp);
      var n = zd,
        e = Rd,
        r = Ld,
        i = n * n + e * e + r * r;
      return i < Id &&
        ...
        (e = Cd),
        (r = Pd),
        Td < Fd && ((n = Nd), (e = Sd), (r = Ed)),
        (i = n * n + e * e + r * r) < Id)
        ? [NaN, NaN]
        : [Qd(e, n) * Vd, lr(r / op(i)) * Vd];
    }),
    (t.geoCircle = function() {
      ...
      return (
        (t.center = function(n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : Wr([+n[0], +n[1]])), t)
            : r;
        }),
        (t.radius = function(n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : Wr(+n)), t)
            : i;
        }),
        (t.precision = function(n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : Wr(+n)), t)
            : o;
        }),
        t
      );
    ...
    (t.geoPath = function(t, n) {
      ...
      return (
        ...
        (e.projection = function(n) {
          return arguments.length
            ? ((r = null == n ? ((t = null), Ci) : (t = n).stream), e)
            : t;
        }),
        (e.context = function(t) {
          return arguments.length
            ? ((i = null == t ? ((n = null), new Vi()) : new Hi((n = t))),
        ...
        (t.translate = function(t) {
          ...
          return (
            ...
            (o = c
              ...
              .clipExtent([
                [r - 0.425 * e + Fd, u + 0.12 * e + Fd],
                [r - 0.214 * e - Fd, u + 0.234 * e - Fd]
              ])
              .stream(l)),
            (a = s
              .translate([r - 0.205 * e, u + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + Fd, u + 0.166 * e + Fd],
                [r - 0.115 * e - Fd, u + 0.234 * e - Fd]
              ])
              .stream(l)),
            n()
          );
    ...
    (t.geoIdentity = function() {
      ...
      return (a = {
        ...
        scale: function(n) {
          return arguments.length
            ? ((h = mo((u = +n) * s, u * l, f, c)), t())
            : u;
        },
        translate: function(n) {
          return arguments.length
            ? ((h = mo(u * s, u * l, (f = +n[0]), (c = +n[1]))), t())
            : [f, c];
        },
        reflectX: function(n) {
          return arguments.length
            ? ((h = mo(u * (s = n ? -1 : 1), u * l, f, c)), t())
            : s < 0;
        },
        reflectY: function(n) {
          return arguments.length
            ? ((h = mo(u * s, u * (l = n ? -1 : 1), f, c)), t())
            : l < 0;
        },
        ...
        return (
          ...
          n
            ...
            : t
                .eachBefore(Wo($o))
                .eachAfter(Zo(Go, 1))
                .eachAfter(Zo(i, t.r / Math.min(e, r)))
      ...
      function t(t) {
        ...
        for (i = 0; i < s; ++i)
          (r = t[i]),
            ...
            null != (f = n(r, i, t)) &&
              (f += "") &&
              (h[(c = dv + (u.id = f))] = c in h ? vv : u);
        for (i = 0; i < s; ++i)
          if (((u = l[i]), null != (f = e(t[i], i, t)) && (f += ""))) {
            if (!(a = h[dv + f])) throw new Error("missing: " + f);
            if (a === vv) throw new Error("ambiguous: " + f);
    ...
    (t.treemap = function() {
      ...
      return (
        ...
        (t.paddingTop = function(n) {
          return arguments.length
            ? ((f = "function" == typeof n ? n : Vo(+n)), t)
            : f;
        }),
        (t.paddingRight = function(n) {
          return arguments.length
            ? ((c = "function" == typeof n ? n : Vo(+n)), t)
            : c;
        }),
        (t.paddingBottom = function(n) {
          return arguments.length
            ? ((s = "function" == typeof n ? n : Vo(+n)), t)
            : s;
        }),
        (t.paddingLeft = function(n) {
          return arguments.length
            ? ((l = "function" == typeof n ? n : Vo(+n)), t)
            : l;
        }),
        t
      );
    ...
    (t.polygonHull = function(t) {
      ...
      for (r.sort(la), n = 0; n < e; ++n) i[n] = [r[n][0], -r[n][1]];
      var o = ha(r),
        a = ha(i),
        u = a[0] === o[0],
    ...
    (t.scaleSqrt = function() {
      return Ua().exponent(0.5);
    }),
    (t.scaleQuantile = qa),
    (t.scaleQuantize = Oa),
    (t.scaleThreshold = Ya),
    (t.scaleTime = function() {
      return ef(ag, ig, Hv, Iv, Bv, Ov, Uv, zv, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2)
      ]);
    }),
    (t.scaleUtc = function() {
      return ef(Cg, Eg, pg, hg, sg, fg, Uv, zv, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2)
      ]);
    }),
    ...
    (t.arc = function() {
      function t() {
        ...
        if ((f || (f = t = re()), l < s && ((c = l), (l = s), (s = c)), l > y_))
          if (p > m_ - y_)
            f.moveTo(l * h_(h), l * v_(h)),
              f.arc(0, 0, l, h, d, !v),
              s > y_ &&
                (f.moveTo(s * h_(d), s * v_(d)), f.arc(0, 0, s, d, h, v));
          else {
            var g,
              y,
              _ = h,
                  ...
                  H =
                    ...
                    v_(
                      (function(t) {
                        ...
                        (B * I + F * j) /
                          (g_(B * B + F * F) * g_(I * I + j * j))
                      ) / 2
                    ),
                  X = g_(Y[0] * Y[0] + Y[1] * Y[1]);
                (S = p_(N, (s - X) / (H - 1))), (E = p_(N, (l - X) / (H + 1)));
              }
            }
            M > y_
              ? E > y_
                  ...
                  E < N
                    ...
                    : (f.arc(
                      ...
                      f.arc(
                        ...
                        0,
                        l,
                        l_(g.cy + g.y11, g.cx + g.x11),
                        l_(y.cy + y.y11, y.cx + y.x11),
                        !v
                      ),
                      f.arc(
                        y.cx,
      ...
      return (
        ...
        (t.padRadius = function(n) {
          return arguments.length
            ? ((i = null == n ? null : "function" == typeof n ? n : ff(+n)), t)
            : i;
        }),
        (t.startAngle = function(n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : ff(+n)), t)
            : o;
        }),
        (t.endAngle = function(n) {
          return arguments.length
    ...
    (t.stack = function() {
      ...
      return (
        (t.keys = function(e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : ff(w_.call(e))), t)
            : n;
        }),
        (t.value = function(n) {
          return arguments.length
        ...
        (t.order = function(n) {
          return arguments.length
            ? ((e =
                null == n ? fc : "function" == typeof n ? n : ff(w_.call(n))),
              t)
            : e;
        }),
        (t.offset = function(n) {
    ...
    (t.voronoi = function() {
      function t(t) {
        return new qc(
          t.map(function(r, i) {
            var o = [
              Math.round(n(r, i, t) / tb) * tb,
              Math.round(e(r, i, t) / tb) * tb
            ];
      ...
      return (
        ...
        (t.x = function(e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : hc(+e)), t)
            : n;
        }),
        (t.y = function(n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : hc(+n)), t)
            : e;
        }),
        (t.extent = function(n) {
          return arguments.length
    ...
    (t.zoom = function() {
      ...
      return (
        ...
        (n.wheelDelta = function(t) {
          return arguments.length
            ? ((b = "function" == typeof t ? t : Oc(+t)), n)
            : b;
        }),
        (n.filter = function(t) {
          return arguments.length
            ? ((g = "function" == typeof t ? t : Oc(!!t)), n)
            : g;
        }),
        (n.touchable = function(t) {
          return arguments.length
            ? ((m = "function" == typeof t ? t : Oc(!!t)), n)
            : m;
        }),
        (n.extent = function(t) {
          return arguments.length
